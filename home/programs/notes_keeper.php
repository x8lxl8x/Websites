...
function get_index()
{
  ...
  $file_template = "{$server_docroot}/{$dir_templates}/notes_keeper_index.html";
  ...
  {
    $links_dirs .= "<div><a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_current}/" . rawurlencode($current_dirs_item) . "'><span class='clIconDir'></span><span class='link_text'>{$current_dirs_item}</span></a></div>\n";
  }
  ...
  foreach ($current_files_array as &$current_files_item)
  {
    ...
    {
      $links_files .= "<div><a href='./notes_keeper.php?varFuncId=view&varDirCurrent={$dir_current}/" . rawurlencode($current_files_item) . "'><span class='clIconTxt'></span><span class='link_text'>{$file_noext}</span></a></div>\n";
    }
  ...
  if ($note_name == basename($dir_start_name) || $note_name == '..')
  {
    ...
    $nav_index  = '';
    $nav_up     = '';
    $nav_add    = "    <a href='./notes_keeper.php?varFuncId=add&varDirCurrent={$dir_current}'><span class='clNavAdd'><span></a>";
    $nav_rename = "";
    $nav_upload = "";
  }
  else
  {
    $nav_index  = "    <a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_start_name}'><span class='clNavIndex'><span></a>";
    $nav_up     = "    <a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_dirname}'><span class='clNavUp'><span></a>";
    $nav_add    = "    <a href='./notes_keeper.php?varFuncId=add&varDirCurrent={$dir_current}'><span class='clNavAdd'><span></a>";
    $nav_rename = "    <a href='./notes_keeper.php?varFuncId=rename&varDirCurrent={$dir_current}'><span class='clNavRename'><span></a>";
    $nav_upload = "    <a href='./notes_keeper.php?varFuncId=upload&varDirCurrent={$dir_current}'><span class='clNavUpload'><span></a>";
  }
...
function get_view()
{
  ...
  $file_template = "{$server_docroot}/{$dir_templates}/notes_keeper_view.html";
  ...
  $nav_up       = "<a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_dirname}'><span class='clNavUp'><span></a>";
  $nav_rename   = "<a href='./notes_keeper.php?varFuncId=rename&varDirCurrent={$dir_current}'><span class='clNavRename'><span></a>";
  $nav_edit     = "<a href='./notes_keeper.php?varFuncId=edit&varDirCurrent={$dir_current}'><span class='clNavEdit'><span></a>";
...
function get_edit()
{
  ...
  $file_template = "{$server_docroot}/{$dir_templates}/notes_keeper_edit.html";
  ...
  {
    $nav_index  = "<a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_start_name}'><span class='clNavIndex'><span></a>";
    $nav_up     = "<a href='./notes_keeper.php?varFuncId=view&varDirCurrent={$dir_current}'><span class='clNavUp'><span></a>";
  }
  else
  {
    $nav_index  = "<a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_start_name}'><span class='clNavIndex'><span></a>";
...
function get_edit_post()
{
  ...
  header("Location: ./notes_keeper.php?varFuncId=view&varDirCurrent={$dir_current}");
}
...
function get_add()
{
  ...
  $file_template = "{$server_docroot}/{$dir_templates}/notes_keeper_add.html";
  ...
  {
    $nav_index  = "<a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_start_name}'><span class='clNavIndex'><span></a>";
    $nav_up     = "<a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_start_name}'><span class='clNavUp'><span></a>";
  }
  else
  {
    $nav_index  = "<a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_start_name}'><span class='clNavIndex'><span></a>";
    $nav_up     = "<a href='./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_current}'><span class='clNavUp'><span></a>";
  }
...
function get_add_post()
{
  ...
  header("Location: ./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_current}");
}
...
function get_rename()
{
  ...
  $file_template = "{$server_docroot}/{$dir_templates}/notes_keeper_rename.html";
...
function get_rename_post()
{
  ...
  header("Location: ./notes_keeper.php?varFuncId=index&varDirCurrent={$dir_dirname}");
}
...
function get_upload()
{
  ...
  $file_template = "{$server_docroot}/{$dir_templates}/notes_keeper_upload.html";
