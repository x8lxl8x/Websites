...
function get_index()
{
  ...
  foreach ($files_array as &$file_name)
  {
    ...
    $page_content .= "<a href='./lyrics-reader.php?varFuncId=view&varAppTitle={$app_title}&varAppArea={$app_area}&varAppDir={$app_dir}&varFileName={$file_name_encoded}'>{$file_name}</a><br>\n";
  }
