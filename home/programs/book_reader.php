...
function get_index()
{
  ...
  elseif (! file_exists("{$app_dir}/{$path_file_index_text}") || ($time_texts_modified > $time_index_modified))
  {
    foreach ($files_array as &$file_name)
    {
      ...
      $page_content .= "<a href='./book_reader.php?varFuncId=view&varAppTitle={$app_title}&varAppArea={$app_area}&varAppDir={$app_dir}&varFileName={$file_name}'>{$link_text}</a><br>\n";
    }
...
#  }
  ...
  $button_editor = "<a href='./book_reader.php?varFuncId=edit&varAppTitle={$app_title}&varAppArea={$app_area}&varAppDir={$app_dir}&varFileName={$file_name}'><span class='clNavEdit'><span></a>";
...
function get_edit_post()
{
  ...
  header("Location: ./book_reader.php?varFuncId=view&varAppTitle={$app_title}&varAppArea={$app_area}&varAppDir={$app_dir}&varFileName={$file_name}");
}
