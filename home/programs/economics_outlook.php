...
function get_index()
{
  ...
  $page_content .= "<p class='clMediaName'><a href='./economics_outlook.php?varFuncId=latest'>Latest</a></p>\n";
  $page_content .= "<p class='clMediaName'><a href='./economics_outlook.php?varFuncId=blog'>Week Ahead</a></p>\n";
  ...
  foreach ($array_indicators as &$array_indicator)
  {
    ...
    $page_content .= "<p class='clMediaName'><a href='./economics_outlook.php?varFuncId=indicator&varInNmCountry={$in_nm_enc_country}&varInNmName={$in_nm_enc_name}&varInIdCountry={$in_id_country}&varInIdName={$in_id_name}'>{$in_nm_name}</a></p>\n";
  }
