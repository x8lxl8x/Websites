...
else if ( $intResult == 2 )
{
  ...
  $strQuery = "select idkey, name_last, name_first, email, date_contacted, date_requested, date_paid, date_completed from aa_client where date_contacted != '0000-00-00' and date_requested != '0000-00-00' and date_paid != '0000-00-00' and date_completed != '0000-00-00' and date_consulted = '0000-00-00' and admin = 'N' order by name_last asc;";
...
//    $strClientsCurrent = $strClientsCurrent . "<tr><th class='clClientTdCenter'>Фамилия</th><th class='clClientTdCenter'>Имя</th><th class='clClientTdCenter'>Ключ</th><th class='clClientTdCenter'>Обращ.</th><th class='clClientTdCenter'>Запро.</th><th class='clClientTdCenter'>Оплач.</th><th class='clClientTdCenter'>Запол.</th></tr>\n";
    $strClientsCurrent = $strClientsCurrent . "<tr><th class='clClientTdCenter'>Фамилия</th><th class='clClientTdCenter'>Имя</th><th class='clClientTdCenter'>Запол.</th></tr>\n";
...
//      $strClientsCurrent = $strClientsCurrent . "<td class='clClientTd'>$strClientDatePaid</td>";
  ...
  $strContent = fncGetTemplate( $strDirPages . '/admin-clients-show-completed.html' );
}
