...
else if ( $intResult == 1 )
{
  ...
  $strMailSubject  = "Запрос на открытие доступа к формам -  $strClientNameFirst $strClientNameLast";

  $strMailData = fncGetTemplate( $strDirMailData . '/client-forms-open.html' );
  ...
  $strContent = fncGetTemplate( $strDirResponses . '/client-forms-open-passed.html' );
}
