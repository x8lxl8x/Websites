...
{
  $strQueryDelete = "delete from aa_form_" . sprintf( "%02d", $intForm ) . " where idkey = '$strClientIdKey';";
  $strQueryInsert = "insert into aa_form_" . sprintf( "%02d", $intForm ) . " values ( '$strClientIdKey', ";
  ...
  if ( $objResult1 && $objResult2 && $objResult3 && $objResult4 )
  {
    ...
    $strContent = fncGetTemplate( $strDirResponses . '/admin-form-passed.html' );
  }
  else
  {
    ...
    $strContent = fncGetTemplate( $strDirResponses . '/admin-form-failed.html' );
  }
}
