...
else if ( $intResult == 2 )
{
  ...
  $strQuery = "select * from aa_recommendation_$strForm where idkey = '$strClientIdKey';";
  ...
  $strFuncOnLoad = 'fncOnLoadRecommendationAdmin( ' . $intForm . ', ' . $intFields . ' );';
  $strContent = fncGetTemplate( $strDirRecommendations . '/' . $strForm . '.html' );
}
