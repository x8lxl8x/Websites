...
else if ( $intResult == 2 )
{
  ...
  $strQuery = "select idkey, name_last, name_first, date_contacted from aa_client where date_contacted != '0000-00-00' and date_requested = '0000-00-00' and date_paid = '0000-00-00' and date_completed = '0000-00-00' and date_consulted = '0000-00-00' and admin = 'N' order by name_last asc;";
  ...
  if ( $intNumberOfRows > 0 )
  {
    ...
    $strClientsCurrent = $strClientsCurrent . "<tr><th class='clClientTdCenter'>Фамилия</th><th class='clClientTdCenter'>Имя</th><th class='clClientTdCenter'>Обращ.</th></tr>\n";
...
//      $strClientsCurrent = $strClientsCurrent . "<td class='clClientTd'>$strClientIdKey</td>";
  ...
  $strContent = fncGetTemplate( $strDirPages . '/admin-clients-show-contacted.html' );
}
